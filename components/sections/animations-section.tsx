...
export default function AnimationsSection() {
    ...
    return (
      <section className="py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="text-center">Loading animations...</div>
        </div>
      </section>
    )
  }
  ...
  return (
    <section id="animations" className="py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tighter">Animation Collection</h2>
            <p className="text-muted-foreground">Browse our curated collection of React animations</p>
          </div>
